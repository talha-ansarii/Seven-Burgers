...
const Home = () => {
  return (
    <div className="w-full overflow-x-hidden bg-bg-yellow h-[1000px]">
      <Navbar />
      <div className="flex flex-col md:flex-row lg:flex-row justify-center items-center md:bg-bg-yellow md:pt-[55px] lg:pt-[55px] pt-[20px] w-full">
