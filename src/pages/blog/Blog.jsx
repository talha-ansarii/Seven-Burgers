      ...
      <div>
        ...
        <div dangerouslySetInnerHTML={{ __html: text1 }} />
          ...
          <div className='w-full flex justify-center items-center mb-12'>
            <img src='/logo.png' alt="logo" className="w-[42px] h-[29px] md:w-[52px] md:h-[36px] lg:w-[70px] lg:h-[49px] mt-4" />
          </div>
          
         
          <div className='w-full flex justify-center items-center'>
            {
              image1 && <img src={image1} alt="pic" className="w-[326px] md:w-[741px] lg:w-[1092px]  h-[204px] lg:h-[573px] md:h-[430px] rounded-[10px] object-contain" />
            }
          </div>
        </div>
...
{
              image2 && <img src={image2} alt="pic" className="w-[326px] md:w-[582px] h-[204px] lg:w-[766px] lg:h-[482px] md:h-[343px] rounded-[10px] object-contain"  />
}          </div>
        </div>
        ...
        <div className="w-[80%] m-auto">
          ...
          {
              image3 && <img src={image3} alt="pic" className="w-[326px] md:w-[582px] h-[204px] lg:w-[766px] lg:h-[482px] md:h-[343px] rounded-[10px] object-contain" />
          }
          </div>
        </div>
        ...
        <div className="w-[80%] m-auto">
          ...
          <div className='flex wfull justify-center items-center'>
          {
              image4 && <img src={image4} alt="pic" className="w-[326px] md:w-[582px] h-[204px] lg:w-[766px] lg:h-[482px] md:h-[343px] rounded-[10px] object-contain" />
          }
          </div>
