    ...
    <div className="w-[318px] relative h-[480px] rounded-[36px] border-[2px] border-black pb-[16px] flex flex-col gap-[10px] bg-white">
      <div className="">
        <img
          src="/image.jpg"
          alt="burger"
          className="absolute w-full object-cover h-[230px] rounded-b-[24px] rounded-t-[35px] border-[2px] border-black"
        />
        <img
          src="/nonveg.svg"
          alt="nonveg"
      ...
      <div className="absolute w-full top-[240px] flex items-center flex-col gap-2 ">
        <div className="inter font-[700] text-[#434343] text-[16px] leading-[19.2px] tracking-[4%] ">CHICKEN BURGER</div>
        ...
        <div className="font-migra font-[800] text-[22px] leading-[26.62px] text-[#233780] text-center">Rs. 500</div>
        <div className="flex items-center w-[280px] h-[53px] justify-evenly">
            <button className="">
                <img src="/minus-circle.svg" alt="minus" />
                
            </button>
                <div className="inter font-[700] text-[24px] leading-[28.8px] tracking-[4%]">1</div>
            <button className="">
