      ...
      <div className="grid md:grid-cols-4 lg:grid-cols-6  grid-cols-2 gap-4 w-[90%]    p-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            ...
            <div className="inter font-[400] text-[12px] leading-[18px]">
              132 Dartmouth <br/> Street Boston,<br/>
               Massachusetts<br/> 02156 United States
            </div>
          </div>
        </div>
        </div>
        ...
        <div className=" flex flex-col gap-2">
          ...
          <Link className="inter font-[400] text-[12px] leading-[18px]">
            Privacy Policy
          </Link>
          <Link className="inter font-[400] text-[12px] leading-[18px]">
            Terms & Services
        ...
        <div className="flex flex-col gap-2">
          ...
          <Link className="inter font-[400] text-[12px] leading-[18px]">Forum</Link>
        </div>
        </div>
